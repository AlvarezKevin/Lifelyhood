"""
Django settings for lifelyhood project.
...
SECRET_KEY = 'django-insecure-nn5+$+0r4iro(^*dca4$v0lc45vrbh+c+jwio@bws28%1^_7yd'
...
#DATABASES = {}
#ATABASES['default'] = dj_database_url.config(conn_max_age=600)